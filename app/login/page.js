              ...
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div className="relative">
                  <button 
                    type="submit" 
                    disabled={loading}
                    className="bg-cyan-500 text-white rounded-md px-4 py-2 w-full hover:bg-cyan-600 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
